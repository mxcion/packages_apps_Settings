...
package com.android.settings.elytra.fragments;
...
import com.elytra.support.preferences.SystemSettingMasterSwitchPreference;
import com.elytra.support.preferences.SystemSettingSeekBarPreference;
import com.elytra.support.preferences.SystemSettingSwitchPreference;
...
public class DisplayCustomizations extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNetworkTraffic.setEntries(ElytraUtils.hasNotch(getActivity()) ? NotchEntries : NonNotchEntries);
        mNetworkTraffic.setEntryValues(ElytraUtils.hasNotch(getActivity()) ? NotchValues : NonNotchValues);
